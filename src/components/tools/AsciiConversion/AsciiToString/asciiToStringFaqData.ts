...
const asciiToStringFaqData: FaqProps[] = [
  ...
  {
    question:
      "Do I need to install anything to use the ASCII to Text Converter?",
    ans: "No.",
  },
  {
    question: "Is my data safe with the ASCII to Text Converter?",
    ans: "Absolutely! We do not store or share any of the data you input into the ASCII to Text Converter.",
  },
  {
    question: "Can I convert a large amount of ASCII codes at once?",
    ans: "Yes",
  },
];

export default asciiToStringFaqData;
