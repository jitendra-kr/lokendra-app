...
export const toolsListData: Array<ITools> = [
  {
    ...
    toolDescription: `Are you tired of spending hours manually converting text to ASCII codes? Our tool is the best way to convert text to ASCII art! You won't have any trouble entering and translating your content because of the simple and clear UI for ASCII Conversion. Convert text quickly and accurately with our free online tool for easy ASCII conversion. Save time and effort with this simple tool. Our online ASCII converter is a powerful that allows you to easily convert any string of text into its corresponding ASCII code. Whether you need to convert a single word, a paragraph, or a document, it can be handled all with ease. Simply enter your text or upload a text file into the tool, and it will instantly generate the corresponding ASCII code for each character.  This tool is beneficial for every person who needs to work with ASCII codes. Best of all, our online ASCII converter is completely free to use and requires no downloads or installations.`,
    keyFeatures: [
  ...
  },
  {
    ...
    toolDescription: `With our cutting-edge ASCII to text converter, you can effortlessly transform your ASCII-encoded data into easily readable strings. This advanced tool is designed to be efficient, accurate, and user-friendly, catering to individuals who require swift processing of vast quantities of data.
