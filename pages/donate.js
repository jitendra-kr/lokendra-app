    ...
    <Content>
      <div className="row">
        ...
        <div className="col-lg-8">
          ...
          <p>
            Thanks for your interest in supporting my work. I don’t charge for
            the content on this site This work takes a lot of time, and your
            donation will allow me to spend even more time creating the content
            people enjoy and working on open source projects that help people do
            their jobs.
            {STRING_CONSTANTS.global.appName} is a highly efficient education
            nonprofit. When you donate to {STRING_CONSTANTS.global.appName}, you
